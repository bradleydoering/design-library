        ...
        {sortedCustomEntries.map(([itemType, item]) => {
          ...
          return (
            <div key={itemType}>
              ...
              <div
                className="border-[6px] border-[#F6F7F9] rounded-xl h-[180px] relative cursor-pointer"
                onClick={() => {
                  if (currentItem) {
              ...
              >
                {isRemoved && (
                  ...
                  >
                    <div className="bg-[#F6F7F9] border-2 border-[#E9E9E9] px-4 py-2 rounded-md">
                    ...
                    {!isRemoved && (
                      ...
                      >
                        <button
                          ...
                          className="p-2 rounded-full border border-[#E9E9E9]"
                        >
                          <Trash className="w-4 h-4 text-[#6B6B6B]" />
                        </button>
                        <button
                          onClick={() => onSwap(itemType)}
                          className="p-2 rounded-full bg-[#EFEADF]"
                        >
