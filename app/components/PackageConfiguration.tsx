...
export default function PackageConfiguration({
    ...
    return (
      <div className="space-y-6 bg-white">
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-1 bg-[#F6F7F9] rounded-[1.2rem] py-3">
              ...
              return (
                ...
                >
                  <button onClick={() => onSizeChange(sizeKey)}>
                    <span
                      className={`py-2 px-6 rounded-full border-[2px] transition-all text-sm
                      ${
        ...
        <div>
          ...
          <div className="flex gap-2">
            {tileConfigs.map((option) => (
              ...
              >
                <span
                  className={`inline-block py-2 px-4 rounded-lg border transition-all text-[0.7rem]
                  ${
  ...
  // Desktop view
  const DesktopView = (
    <aside className="hidden lg:block fixed top-28 right-[max(16px,calc(50%-550px))] w-[400px] z-[1] mx-auto border-[6px] border-[#F6F7F9] bg-white rounded-[20px]">
      <div className="p-6">
        <ConfigContent />
      </div>
    </aside>
  ...
  const MobileView = (
    <div className="lg:hidden fixed bottom-2 left-0 w-full z-[10]">
      ...
      >
        {/* Toggle Header */}
        {!isExpanded && (
          <div className="flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-sm rounded-[20px] shadow-md mb-4  max-w-[450px] mx-auto">
            ...
            <button
              ...
              className="px-6 py-2 bg-[#2D332C] text-white rounded-full hover:bg-opacity-90 transition-colors"
            >
              Continue
            </button>
          </div>
        ...
        {/* Expanded Content */}
        {isExpanded && (
          <div className="px-4 pt-4 pb-3 max-w-[450px] mx-auto bg-white border-[6px] border-[#F6F7F9] rounded-[20px] z-2 scale-x-[0.9] scale-y-[0.9] scale-origin-bottom">
            <button
